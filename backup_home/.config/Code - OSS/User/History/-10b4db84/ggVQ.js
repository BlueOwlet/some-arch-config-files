...
config.websocket = 'wss://meet.vyda.mx/' + subdir + 'xmpp-websocket';
...
config.constraints.video.height = { ideal: 720, max: 1080, min: 144 };
//config.constraints.video.width = { ideal: 1280, max: 1280, min: 192};
...
config.desktopSharingFrameRate = { min: 15, max: 120 };
...
config.transcription.translationLanguagesHead = ['en','es'];
