...
var interfaceConfig = {
    ...
    BRAND_WATERMARK_LINK: 'https://vyda.mx/favicon.ico',

    CLOSE_PAGE_GUEST_HINT: false, // A html text to be shown to guests on the close page, false disables it

    DEFAULT_BACKGROUND: '#040404',
    DEFAULT_WELCOME_PAGE_LOGO_URL: 'https://vyda.mx/favicon.ico',
    ...
    JITSI_WATERMARK_LINK: 'https://vyda.mx/favicon.ico',
     ...
     * @type {number}
     */
    MAXIMUM_ZOOMING_COEFFICIENT: 1.1,
    ...
    SHOW_JITSI_WATERMARK: false, // uses jitsi watermark
    SHOW_POWERED_BY: false, // uses powered by jitsi
    SHOW_PROMOTIONAL_CLOSE_PAGE: false, // uses close3.html
