...
def select_area(driver):
    ...
    country_options = filter_by_country(options, country)

    print("Filtered options:", country_options)
...
def get_country():
    ...
    countries = {option.text.split(',')[-1].strip() for option in countries}
