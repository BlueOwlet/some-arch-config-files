...
restore_jitsi(){
    ...
    # sudo cp backup/jitsi/docker-compose.yml ~/jitsi/
    
    cp backup/jitsi/custom-config.js ~/.jitsi-meet-cfg/web/
    cp backup/jitsi/custom-interface_config.js ~/.jitsi-meet-cfg/web/
    echo "passingby"
...
update_config(){
    sudo cp ~/jitsi/.env ~/.jitsi-meet-cfg/web/
    sudo cp ~/jitsi/custom-config.js ~/.jitsi-meet-cfg/web/
    sudo cp ~/jitsi/custom-interface_config.js ~/.jitsi-meet-cfg/web/
