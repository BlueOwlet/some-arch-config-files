...
python ./manage.py createsuperuser --noinput --email owl@owl.com --username fernando --first_name Fernando --last_name Ortiz --role Admin --cellphone 0000000  --password demet962
python ./manage.py createsuperuser --noinput --email owl@owl.com --username levi --first_name levi --last_name Ortiz --role Admin --cellphone 0000000  --password levi
