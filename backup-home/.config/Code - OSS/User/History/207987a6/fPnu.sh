...
backup_jitsi(){
    ...
    sudo cp /etc/containers/registries.conf backup/jitsi/ 
    sudo cp ~/.config/cni/net.d/docker-jitsi-meet_meet.jitsi.conflist backup/jitsi

}

restore_jitsi(){
    sudo cp backup/jitsi/docker-jitsi-meet_meet.jitsi.conflist /etc/cni/net.d/
    sudo cp backup/jitsi/docker-jitsi-meet_meet.jitsi.conflist ~/.config/cni/net.d/
    sudo cp backup/jitsi/registries.conf /etc/containers/
