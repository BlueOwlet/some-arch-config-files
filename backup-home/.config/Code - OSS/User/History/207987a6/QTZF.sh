...
backup_jitsi(){
    ...
    sudo cp ~/.config/cni/net.d/jitsi-meet_meet.jitsi.conflist backup/jitsi

}

restore_jitsi(){
    sudo cp backup/jitsi/jitsi-meet_meet.jitsi.conflist /etc/cni/net.d/
    sudo cp backup/jitsi/jitsi-meet_meet.jitsi.conflist ~/.config/cni/net.d/
